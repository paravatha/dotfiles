...
alias knsdev="kubectl config set-context --current --namespace dev && kubeon "
alias knsprd="kubectl config set-context --current --namespace prd && kubeon  "
alias kev="kubectl get events --sort-by=.metadata.creationTimestamp"
alias knodes="kubectl get nodes -o wide "
alias knr="kubectl node-resource utilization "
alias kpods="kubectl get pods -o wide"
alias kdock="kubectl config use-context docker-desktop && kubeon "
alias kranch="kubectl config use-context rancher-desktop && kubeon "
...
alias tfrm="rm -rf .terraform .terraform.lock.hcl terraform.tfstate*"
